	...
	return t.fn.Paging = function(i) {
		...
		init: function(i) {
			this.settings = t.extend({
				...
				toolbar: !1,
				hash: !1,
				pageSizeList: [3, 5, 7, 9, 11]
				/*pageSizeList: [2, 4, 6, 8, 10]*/ // 可以自己改动，一定要和回调函数里的pageSize有对应
		...
		format: function() {
			...
			i += '<li class="js-page-next js-page-action ui-pager">' + this.settings.nextTpl + "</li>", i += '<li class="js-page-last js-page-action ui-pager">' + this.settings.lastTpl + "</li>", i += "</ul>", this.container.html(i), 1 == this.current && (t(".js-page-prev", this.container).addClass("ui-pager-disabled"), t(".js-page-first", this.container).addClass("ui-pager-disabled")), this.current == this.pagecount && (t(".js-page-next", this.container).addClass("ui-pager-disabled"), t(".js-page-last", this.container).addClass("ui-pager-disabled")), this.container.find('li[data-page="' + this.current + '"]').addClass("focus").siblings().removeClass("focus"), this.settings.toolbar && this.bindToolbar()
				/*i += '<li class="js-page-next js-page-action ui-pager">' + this.settings.nextTpl + "</li>", i += '<li class="js-page-last js-page-action ui-pager">' + this.settings.lastTpl + "</li>", i += '<li>第' + this.settings.current + "页</li>", i += '<li>共' + this.pagecount + "页</li>", i += "</ul>", this.container.html(i), 1 == this.current && (t(".js-page-prev", this.container).addClass("ui-pager-disabled"), t(".js-page-first", this.container).addClass("ui-pager-disabled")), this.current == this.pagecount && (t(".js-page-next", this.container).addClass("ui-pager-disabled"), t(".js-page-last", this.container).addClass("ui-pager-disabled")), this.container.find('li[data-page="' + this.current + '"]').addClass("focus").siblings().removeClass("focus"), this.settings.toolbar && this.bindToolbar()*/
		},
		/* 
		 * this.pagecount  总页数
		 * this.count  总记录数
		 * this.current  当前是第几页
		 * this.pagesize  每页的条数
		 * this.settings.current  当前是第几页
		 */
		bindToolbar: function() {
			for(var i = this, e = t('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">跳转</a><li><span> 第 ' + this.settings.current + ' 页 </span><span> , 共 ' + this.pagecount + ' 页 </span><span> , 共 ' + this.count + ' 条记录 </span></li></li>'), s = t(".ui-select-pagesize", e), a = "", n = 0, r = this.settings.pageSizeList.length; n < r; n++) a += '<option value="' + this.settings.pageSizeList[n] + '">' + this.settings.pageSizeList[n] + "条/页</option>";
			/*for(var i = this, e = t('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">跳转</a><li><span> 第 ' + this.settings.current + ' 页#'+this.current+'#,'+this.pagesize+',# </span><span> , 共 ' + this.pagecount + ' 页 </span><span> , 共 ' + this.count + ' 条记录 </span></li></li>'), s = t(".ui-select-pagesize", e), a = "", n = 0, r = this.settings.pageSizeList.length; n < r; n++) a += '<option value="' + this.settings.pageSizeList[n] + '">' + this.settings.pageSizeList[n] + "条/页</option>";*/
