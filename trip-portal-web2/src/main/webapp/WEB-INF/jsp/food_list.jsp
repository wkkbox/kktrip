...
<link href='http://fonts.useso.com/css?family=Roboto+Condensed:300italic,400italic,700italic,400,300,700' rel='stylesheet' type='text/css'>-->
    ...
    <script>
        $(function () {
            ...
            function search(foodName, currentPage, pageSize) {
                var jdata = {"foodName": foodName, "currentPage": currentPage, "pageSize": pageSize, "tid": 1};
                $.ajax({
                    url: "${pageContext.request.contextPath}/tour/foodList",
                    data: jdata,
                    dataType: "json",
                    type: "post",
                    cache: false,
                    ...
                    <div class="caption tour-caption">
                        ...
                        * */
                        ...
                        for (var i = 0; i < list.length; i++) {
                            var price=list[i].temp2;
                            var foodPrice=price/100;
                        ...
                        $('#pageToolbar').Paging({
                            ...
                            changePagesize: function(pageSize) {
                                ...
                                //alert(pageSize);
                                search(foodName , 1 , pageSize); // currentPage,pageSize
                            },
                            // 点击具体某一页执行的函数
                            callback: function(currentPage) {
                                ...
                                search(foodName , currentPage , arguments[1]); // currentPage,pageSize
                            }
                        });
                    },
                    error: function () {
    ...
    <div class="container">
        ...
        <form class="navbar-form navbar-right" role="search">
            <div class="form-group">
                <input id="foodName" type="text" class="form-control" placeholder="搜索">
            </div>
